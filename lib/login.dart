...
class _TextFormFieldExampleState extends State<LoginScreen> {
  ...
  Future<void> authenticate() async {
    ...
    if (authorized == 'Authorized') {
      Services.myalerts = await Services.getAlerts(Services.realcustomer.first.customer_id);

      for(var alert in Services.myalerts){
        if(alert.type == 'motion'){
          Services.motionalerts.add(alert);
        }
        else if(alert.type == 'object'){
          Services.objectalerts.add(alert);
        }
        else if(alert.type == 'criminal'){
          Services.criminalalerts.add(alert);
        }
        else if(alert.type == 'false'){
          Services.falsealerts.add(alert);
        }
      }
                ...
                Form(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      const Text("Welcome Dear User,Kindly Login",
                          style: TextStyle(
                            color: Colors.black,
                          )),
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            await Services.logCustomer(email.text, pass.text)
                                .then((value) {
                              setState(() {
                                currentCustomer = value;
                                Services.realcustomer = value;
