...
class _TextFormFieldExampleState extends State<RegisterScreen> {
  ...
  void startPlaces() async {
    ...
    _regionList = locations
        .map((DefaultPlace place) => DropdownMenuItem<String>(
    ...
    _regionList.clear();
    _regionList = _tempy
        .map((String str) => DropdownMenuItem<String>(
              value: str,
              child: Text(str),
            ))
        .toList();
  ...
  Widget _buildStreet() {
    return TextFormField(
      ...
      decoration: const InputDecoration(
          ...
          filled: true,
          icon: Icon(Icons.add_road, color: Colors.blue),
        ...
        trailing: DropdownButton<String>(
          ...
          onChanged: (String? newValue) => setState(() {
            ...
            for (var item in locations) {
              print('hi');
              if (item.region_name == _regVal &&
                  item.district_name == _disVal &&
                  item.area_name == _areaVal) {
                            ...
                            await Services.addCustomer(
                              ...
                              if (value.length > 50) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                        'Failed to register you, Check your Internet '
